            ...
            <div className="content">
              <div className="contact-info" data-aos="fade-right">
                <ul className="circle-cont">
                  <li>
                    <a className="circle2">
                      <i class="fas fa-phone-square-alt"></i>+91 9079045103
                    </a>
                  </li>
                  <li className="mx-auto flex sm:flex-nowrap">
                    ...
                    75mohitsharma@gmail.com
                  </li>
                  <li>
                    <a
                      href="https://github.com/mohitsharma9001"
                      target="_blank"
                      className="circle"
                    >
                  ...
                  <li>
                    <a
                      href="https://www.linkedin.com/in/mohit-sharma-333877217/"
                      target="_blank"
                      className="circle"
                    >
